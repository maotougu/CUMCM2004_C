...
def save_results(decision_vars,results,year):
    ...
    if year == 2030:
        ...
        result_df.to_excel("my_result1_2.xlsx", index=False)
...
def main():
    ...
    process_file('my_result1_2.xlsx', ('datas/缓存-result1_2（空白）.xlsx', 'datas/缓存-result1_2.xlsx'),
                         'datas/附件3-result1_2.xlsx')
